public class GlobalState {
    ...
    public static int UnderThresholdOfRange = 75;
    public static int OverThresholdOfRange = 105;
    public static int NumberOfSegmentsPerDimension = 8; // segment degree
    ...
    public static String DRDA_MODE = "ON"; // "ON" or "OFF"
}